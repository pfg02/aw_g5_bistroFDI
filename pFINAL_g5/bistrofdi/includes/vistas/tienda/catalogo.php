                            ...
                            <div class="lista-productos">
                                <?php foreach ($productosCat as $p): ?>
                                    <?php
										...
										$ingredientes = (string) ($p->ingredientes ?? 'No especificados');
                                    ...
                                    >
                                        ...
                                        <div class="info-producto">
                                            ...
                                            <button
												...
												data-ingredientes="<?= htmlspecialchars($ingredientes, ENT_QUOTES, 'UTF-8') ?>"
                                            >
                                                Ver producto
                                            </button>
                                        </div>
...
<div id="modalDetalle" class="modal-fondo">
    <div class="modal-contenido">
		...
		<div class="modal-ingredientes">
    		<strong>Ingredientes:</strong> <span id="modalIngredientes">Cargando...</span>
		</div>
